...
Как оказалось - это немного путает, я сам, например, мобильными версиями на черных списках так и не воспользовался,
теперь будет все проще.

Новая сортировка:
1) Черные списки 2 штуки: Vless и SS+All (Shadowsocks и остальные), без разделения на кабель и телефон.

Почему? При черных списках (обычном интернете), в целом, что у кабельных, что у мобильных операторов работает одинаково,
поэтому нет большого смысла разделять. 
Есть разделение по протоколам (Vless, SS+All), этого достаточно.

2) Белые списки 3 штуки: Vless-кабель, Vless-телефон, Удаленные.

Разделение по кабелю и телефону оправдало себя, так как для мобильных операторов идут отдельные правила игры.
